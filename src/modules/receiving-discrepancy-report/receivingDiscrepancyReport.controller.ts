...
import { ReceivingDiscrepancyReportService } from "./receivingDiscrepancyReport.service";

export class ReceivingDiscrepancyReportController {
    private service = new ReceivingDiscrepancyReportService();

    async getReceivingDiscrepancyReport(c: Context): Promise<Response> {
       try {
            ...
            const response = await this.service.getReceivingDiscrepancyReport({
                user_name, 
                env, 
                branch,
    ...
    async getReceivingDiscrepancyReportStatus(c: Context): Promise<Response> {
       try {
            const user = c.get('user') ?? { user_name: c.req.query('user_name') as string };
            ...
            const response = await this.service.getReceivingDiscrepancyReportStatus({
                user_name, 
                env, 
                branch,
                initialReceiptStartDate,
